...
import { BookOpen, Upload, X, Plus, Save, Edit, Image, FileText, Tag, Clock, Palette } from 'lucide-react';
...
const NovelEdit = () => {
  ...
  useEffect(() => {
    ...
    if (foundNovel) {
      ...
      // 设置章节数据
      const chapterForms: ChapterForm[] = foundNovel.chapters?.map(chapter => ({
        title: chapter.title,
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {errors[`chapter_${index}_title`] && (
                          <p className="mt-1 text-sm text-red-600">{errors[`chapter_${index}_title`]}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {errors[`chapter_${index}_content`] && (
                          <p className="mt-1 text-sm text-red-600">{errors[`chapter_${index}_content`]}</p>
                        )}
                      </div>
                    </div>
                  </div>
