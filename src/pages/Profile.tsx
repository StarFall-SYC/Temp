...
import { User, BookOpen, Edit, Trash2, Plus, Eye, Calendar, Settings, Upload, X } from 'lucide-react';
...
const Profile = () => {
  ...
  const { novels, loading, fetchUserNovels, deleteNovel, createNovel, uploadCover } = useNovelStore();
                                ...
                                <div className="space-y-3">
                                  <div>
                                    <input
                                      ...
                                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                                        errors[`chapter_${index}_title`] ? 'border-red-500' : 'border-gray-300'
                                      }`}
                                      placeholder="章节标题"
                                    />
                                    {errors[`chapter_${index}_title`] && (
                                      <p className="text-red-500 text-sm mt-1">{errors[`chapter_${index}_title`]}</p>
                                    )}
                                  </div>
                                  ...
                                  <div>
                                    <textarea
                                      ...
                                      rows={8}
                                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                                        errors[`chapter_${index}_content`] ? 'border-red-500' : 'border-gray-300'
                                      }`}
                                      placeholder="章节内容"
                                    />
                                    {errors[`chapter_${index}_content`] && (
                                      <p className="text-red-500 text-sm mt-1">{errors[`chapter_${index}_content`]}</p>
                                    )}
                                  </div>
                                </div>
                              </div>
