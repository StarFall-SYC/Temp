  ...
  const handleAvatarUpload = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        useAuthStore.getState().setUser(data.data.user, useAuthStore.getState().token || ""); // 更新store中的用户数据
        setAvatarFile(null);
      } else {
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500 mb-4">
          <div className="flex items-center space-x-4">
            <div className="relative w-16 sm:w-20 md:w-24 h-16 sm:h-20 md:h-24 rounded-full overflow-hidden border-4 border-blue-400 shadow-lg">
              <img
                src={
                  avatarPreview ||
      ...
      <div className="container mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="max-w-7xl mx-auto">
            {/* 用户信息卡片 - 增强版 */}
            <div className="bg-white rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 relative overflow-hidden">
              {/* 背景装饰 */}
              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2">{targetUsername}</h1>
                  ...
                  {isOwnProfile && (
                    <div className="flex space-x-3">
                      <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2">
            ...
            <div className="bg-white rounded-2xl shadow-xl mb-8">
              <div className="border-b border-gray-200">
                <nav className="flex space-x-2 sm:space-x-4 md:space-x-8 px-3 sm:px-6 md:px-8 overflow-x-auto">
                  <button
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-8">
                      ...
                      {isOwnProfile && (
                        <button
                          onClick={() => setActiveTab('creation')}
                          className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg text-sm sm:text-base hover:from-purple-700 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2"
                        >
