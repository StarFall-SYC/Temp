...
import ProfileSimple from './pages/Profile_Simple';
...
import NovelPublisher from './pages/NovelPublisher';
      ...
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-blue-50">
        ...
        <main className="container mx-auto px-4 py-8">
          <Routes>
            ...
            <Route path="/profile/:username" element={<ProfileSimple />} />
            ...
            <Route path="/editor/:username/:title" element={<NovelEditor />} />
            <Route path="/publish" element={<NovelPublisher />} />
            <Route
              path="*"
              element={
                <div className="text-center py-20">
                  <h1 className="text-2xl text-gray-600">页面未找到</h1>
                </div>
              }
            />
          </Routes>
