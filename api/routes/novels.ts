 ...
 */
router.get('/:username/:title', optionalAuth, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.put('/:username/:title', authenticateToken, async (req: Request, res: Response): Promise<void> => {
  try {
    const { username, title } = req.params;
 ...
 */
router.delete('/:username/:title', authenticateToken, async (req: Request, res: Response): Promise<void> => {
  try {
    const { username, title } = req.params;
 ...
 */
router.post('/:username/:title/chapters', authenticateToken, async (req: Request, res: Response): Promise<void> => {
  try {
    const { username, title } = req.params;
 ...
 */
router.post('/:username/:title/cover', authenticateToken, upload.single('cover'), async (req: Request, res: Response): Promise<void> => {
  try {
    const { username, title } = req.params;
